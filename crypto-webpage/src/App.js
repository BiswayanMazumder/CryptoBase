...
import Careeropenings from './Careers Page/careeropenings';
import Currencycap from './Currency Details/currencycap';
function App() {
  return (
    <BrowserRouter>
      <Routes>
      ...
      <Routes>
        <Route path="/openings" element={<Careeropenings />} />
      </Routes>
      <Routes>
        <Route path="/currencydetails" element={<Currencycap />} />
      </Routes>
      <Analytics />
    </BrowserRouter>
  );
